...
readonly SCRIPT_TAG_LINE="Setup Personal Debian Headless System"
...
printHeader() {
    ...
    printf " /   |   \   ____  _____     __| _/|  |    ____    ______  ______\n"
    printf "/    ~    \_/ __ \ \__  \   / __ | |  |  _/ __ \  /  ___/ /  ___/\n"
    printf "\    Y    /\  ___/  / __ \_/ /_/ | |  |__\  ___/  \___ \  \___ \ \n"
    printf " \___|_  /  \___  >(____  /\____ | |____/ \___  >/____  >/____  >\n"
    printf "       \/       \/      \/      \/            \/      \/      \/ \n"
    printf "\n"
...
taskHeadlessDotfiles || logWarn "Dotfiles not installed, System may not work as expected!"
